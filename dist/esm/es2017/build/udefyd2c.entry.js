...
class DateHelper {
    ...
    static getDateRange(startDate, endDate) {
        var dates = [];
        var currDate = hooks(startDate).startOf('day');
        var lastDate = hooks(endDate).startOf('day');
    ...
    static getNextMonday(date) {
        return hooks(date).day(8).toDate();
    }
    static areDatesEqual(date1, date2) {
        return hooks(date1).format('DDMMYYYY') === hooks(date2).format('DDMMYYYY');
    }
    static isGreaterThenOrEqual(date1, date2) {
        return hooks(date1).diff(date2) >= 0;
    }
    static isLessThenOrEqual(date1, date2) {
        return hooks(date1).diff(date2) <= 0;
    }
    static getWeekDay(date) {
        return hooks(date).weekday();
    }
}

var CalendarMonthType;
(function (CalendarMonthType) {
    CalendarMonthType["January"] = "jan";
    CalendarMonthType["February"] = "feb";
    CalendarMonthType["March"] = "mar";
    CalendarMonthType["April"] = "apr";
    CalendarMonthType["May"] = "may";
    CalendarMonthType["June"] = "jun";
    CalendarMonthType["July"] = "jul";
    CalendarMonthType["August"] = "aug";
    CalendarMonthType["September"] = "sep";
    CalendarMonthType["October"] = "oct";
    CalendarMonthType["November"] = "nov";
    CalendarMonthType["December"] = "dec";
